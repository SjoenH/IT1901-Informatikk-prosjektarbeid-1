...
\includepdf[pages=1,pagecommand={\subsection{Testplan}}]{vedlegg/testplan}
\includepdf[pages={2-}]{vedlegg/testplan}


\includepdf[pages=1,pagecommand={\subsection{Brukbarhetstester}}]{vedlegg/brukbarhetstest}
\includepdf[pages={2-}]{vedlegg/brukbarhetstest}

%\addcontentsline{toc}{subsection}{Brukbarhetstest}
%\includepdf[pages={-}]{vedlegg/testplan/Brukbarhetstest}
...
\includepdf[pages= 1, pagecommand={\subsection{Teknisk Brukermanual}}]{vedlegg/tekniskbrukermanual}
...
\label{release1}
\includepdf[pages={-}]{vedlegg/releaseP1}

\addcontentsline{toc}{subsubsection}{Releaseplan}
\label{release2}
\includepdf[pages={-}]{vedlegg/releaseP2}

\addcontentsline{toc}{subsubsection}{Releaseplan-v3}
\label{release3}
\includepdf[pages={-}]{vedlegg/releaseP3}
